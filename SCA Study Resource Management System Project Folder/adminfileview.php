...
<ul style="list-style-type: none;">
  ...
  <li><a href="adminfileview.php" class="link l5 active"><i class="fa fa-file" aria-hidden="true"></i> Files</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="admin_add_files.php" method="post" id="regform" enctype="multipart/form-data">
        <div class="form-group"><?php getSubject(); echo $subject;?></div>
          <div class="form-group"><?php getFaculty(); echo $faculty;?></div>
          <div class="form-group"><input type="text" name="filetitle" placeholder="File Title" class="form-control" ></div>
...
<!--The files upload view-->
 <div class="container-fluid studentspage">
    ...
    <div class="row head line text-center">
      <div class="col-sm-2">FLID</div>
      <div class="col-sm-2">SID Subject</div>
      <div class="col-sm-2">FID Faculty</div>
...
<?php
        ...
        function getSubject(){
          ...
          function getFaculty(){
                include 'connectdb.php';
                global $faculty ;
                $faculty='<select class="custom-select faculty" name="faculty"> <option value="" selected>Faculty</option>';

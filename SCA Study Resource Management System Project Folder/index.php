...
<body>
			...
			<div class="row">
				<div class="col-sm-6 d-none d-md-block d-lg-block col1">
					<img src="images/img-01.png" class="rounded-circle logimage">
				</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="logincheck.php" method="post" enctype="multipart/form-data" name="loginForm" id="loginForm">
					...
					<div class="custom-control form-group custom-checkbox">
    					<input type="checkbox" class="custom-control-input" id="customCheck" name="rem" value="1">
			...
			<div class="row footer">
				...
				<div class="col-sm-6 ">
					<a href="studentregistrationpage.php">Do not have account?</a>
				</div>
			</div>
			<div class="row footer">

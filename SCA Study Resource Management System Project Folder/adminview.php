...
<ul style="list-style-type: none;">
  ...
  <li><a href="adminview.php" class="link l4 active"><i class="fas fa-user-cog"></i>  Admin</a></li>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog modal-dialog-centered">
      ...
      <div class="modal-body">
        <form action="admin_add_profile.php" method="post" id="regform" enctype="multipart/form-data">
